...
## Import-D365Bacpac -ImportModeTier1 -BacpacFile "$bacpacFileNameAndPath" -ModelFile $modelFileUpdatedPath -NewDatabaseName $NewDatabaseName -DiagnosticFile $DiagnosticFile
